...
The first 2 graphs represent the peak occupancy of ICU and hospital beds. The gray bars represent the Imperial College scenarios: early strict lockdown, late strict lockdown, and no action. The red bar represents the reality. Since Sweden has implemented social distancing measures without imposing lockdown, the observed numbers should have been somewhere between the "lockdown" and "no restictions" scenarios. The reality is quite different. Even though Sweden did NOT implement lockdown, the scenarios WITH confinement overestimate the peak of used beds by a factor 2 to 10. A scenario with some restrictions should be between lockdown and no restrictions scenarios, yielding a overestimation by a factor 10 to 60.
...
Before these dates, a number of measures cis very unlikely to impact the national dynamics of the epidemic: on 25 February weekend lockdown in Dunkerque and part of the Alpes-Maritimes, and on 4 March weekend lockdown in Pas-de-Calais, as well as closed shopping centers of more than 10,000 m2.
...
However, we could not find such a projection in [the February 8 report](https://modelisation-covid19.pasteur.fr/variant/RapportInstitutPasteur_variants_8fevrier2021.pdf)r. All those we found are represented on our graphs presented above. 
...
For the May 21 report, we did not need to check the hypotheses, as Simon Cauchemez himself had compared the epidemic trajectory to his scenarios, and th significant differences only occur after mid-June.
